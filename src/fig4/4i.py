...
# %%
dir_base = "/mnt/liudong/task/20230703_HT_Oct4NanogN70_CUTTAG/result/20230830.EachOtherEnrich"
...
# %%
palette="#008792\n#A14C94\n#15A08C\n#87C232\n#8B7E75\n#1E7CAF\n#46489A\n#0F231F\n#1187CD\n#b7704f\n#596032\n#2570a1\n#281f1d\n#de773f\n#525f42\n#2585a6\n#2f271d\n#c99979\n#5f5d46\n#1b315e\n#1d1626\n#16557A\n#C7A609\n#87C232\n#008792\n#A14C94\n#15A08C\n#8B7E75".split("\n")
dir_bed = "/mnt/liudong/task/20230703_HT_Oct4NanogN70_CUTTAG/result/20230829.EachOther/Brg1New_Flag/bed_types"
...
def enrich_main(file_bed_dict: dict, dict_type_name: str):
    global palette, dir_base, dir_bed, type_beds
    ...
    bed_dict = {
        type_bed: os.path.join(dir_bed, "{}.bed".format(type_bed)) for type_bed in type_beds
    }
    ...
    plt.savefig(
        os.path.join(dir_base, "enrich.zscore.{}.scatter.4region.pdf".format(dict_type_name)),
        bbox_inches="tight",
        dpi=200
    )
    # plt.show()
    ...
    plt.savefig(
        os.path.join(dir_base, "enrich.zscore.{}.bar.4region.pdf".format(dict_type_name)),
        bbox_inches="tight",
        dpi=200
    )
    # plt.show()
...
# %%
file_bed_dict = {
    "Promoter": "/mnt/liudong/task/20230703_HT_Oct4NanogN70_CUTTAG/result/20230807.GeneRegions.20230901/mm10.promoter.ncbiRefSeq.WithUCSC.bed",
